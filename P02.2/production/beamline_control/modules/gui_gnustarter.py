...
#GNUPLOTPATH = ["C:\\Windows\\System32\\cmd.exe"]
ONLINEPATH  = ['/usr/bin/xterm -T online -e "/home/experiment/Spectra/bin/gra_main_vme -online -novme -c online_user.xml"']
ONLINEEXPPATH  = ['/usr/bin/xterm -T online -e "/home/experiment/Spectra/bin/gra_main_vme -online -novme"']

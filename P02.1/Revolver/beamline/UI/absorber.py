...
# Form implementation generated from reading ui file '/tmp/tmpW70HHJ.ui'
#
# Created: Fri Oct 11 18:22:35 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/sps_closed.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/sps_open.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/sps_closed.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        self.device_button.setIcon(icon)
        self.device_button.setIconSize(QtCore.QSize(126, 156))
        ...
        QtCore.QObject.connect(self.device_button, QtCore.SIGNAL("clicked()"), Form.action_device)

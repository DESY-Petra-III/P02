...
# Form implementation generated from reading ui file '/tmp/tmpITH94T.ui'
#
# Created: Fri Oct  4 16:20:48 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/x-ray.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/x-ray.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/x-ray.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)

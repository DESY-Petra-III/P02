...
# Form implementation generated from reading ui file '/tmp/tmp97YndQ.ui'
#
# Created: Thu Oct 10 20:15:32 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.device_button.setCursor(QtCore.Qt.ArrowCursor)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/wall.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/wall.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/wall.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)

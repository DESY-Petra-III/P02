...
# Form implementation generated from reading ui file 'beamline_default.ui'
#
# Created: Wed Oct 15 16:37:46 2014
...
"}")
        ...
        self.beamline_device_controls.setMinimumSize(QtCore.QSize(25, 25))
...
"}")
        ...
        self.gridLayout_9.addWidget(self.button_expert_mode, 0, 8, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.pushButton_2, 0, 5, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.pushButton_3, 0, 3, 1, 1)
        self.pushButton_4 = QtGui.QPushButton(self.beamline_controls)
        self.pushButton_4.setMinimumSize(QtCore.QSize(0, 0))
        self.pushButton_4.setMaximumSize(QtCore.QSize(9999999, 999999))
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/devices/main.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.pushButton_4.setIcon(icon3)
        self.pushButton_4.setObjectName("pushButton_4")
        self.gridLayout_9.addWidget(self.pushButton_4, 0, 0, 1, 1)
        self.pushButton_5 = QtGui.QPushButton(self.beamline_controls)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/devices/temp.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.pushButton_5.setIcon(icon4)
        self.pushButton_5.setObjectName("pushButton_5")
        self.gridLayout_9.addWidget(self.pushButton_5, 0, 1, 1, 1)
        spacerItem2 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.gridLayout_9.addItem(spacerItem2, 0, 7, 1, 1)
        ...
        QtCore.QObject.connect(self.pushButton_5, QtCore.SIGNAL("clicked()"), Form.action_open_temperature_macro)
        QtCore.QObject.connect(self.pushButton_4, QtCore.SIGNAL("clicked()"), Form.action_open_revolver)
    ...
    def retranslateUi(self, Form):
        ...
        self.button_expert_mode.setText(QtGui.QApplication.translate("Form", "Expert mode", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_2.setText(QtGui.QApplication.translate("Form", "Macro executor", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_3.setText(QtGui.QApplication.translate("Form", "Meas. group editor", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_4.setText(QtGui.QApplication.translate("Form", "Revolver", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_5.setText(QtGui.QApplication.translate("Form", "Temperature macro", None, QtGui.QApplication.UnicodeUTF8))

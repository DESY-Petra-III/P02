...
# Form implementation generated from reading ui file '/tmp/tmpeHmClO.ui'
#
# Created: Fri Oct  4 16:58:22 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/slits.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/slits.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/slits.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        self.device_button.setIcon(icon)
        self.device_button.setIconSize(QtCore.QSize(47, 150))

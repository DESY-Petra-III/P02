...
# Form implementation generated from reading ui file '/tmp/tmpg3aaBc.ui'
#
# Created: Thu Oct 10 18:39:35 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.device_button.setStyleSheet("QPushButton#device_button {border:0;background:transparent;margin:0;padding:0} :checked {border:0;background-color: transparent;margin:0;padding:0} :pressed {border:0;background-color: transparent;margin:0;padding:0}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/shutter_closed.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/shutter_open.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.device_button.setIcon(icon)
        self.device_button.setIconSize(QtCore.QSize(51, 151))

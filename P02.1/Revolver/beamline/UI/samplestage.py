...
# Form implementation generated from reading ui file '/tmp/tmpCCOFYY.ui'
#
# Created: Fri Oct  4 16:03:39 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/stage.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/stage.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/stage.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)

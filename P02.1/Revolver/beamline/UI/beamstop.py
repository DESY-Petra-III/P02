...
# Form implementation generated from reading ui file '/tmp/tmprNspXl.ui'
#
# Created: Thu Oct 24 18:31:07 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/beamstop.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/beamstop.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/beamstop.png"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        self.device_button.setIcon(icon)
        self.device_button.setIconSize(QtCore.QSize(58, 149))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "Beamstop", None, QtGui.QApplication.UnicodeUTF8))

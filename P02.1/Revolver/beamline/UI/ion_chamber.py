...
# Form implementation generated from reading ui file '/tmp/tmpfAvypL.ui'
#
# Created: Fri Oct  4 15:46:30 2013
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/ion_chamber.png"), QtGui.QIcon.Active, QtGui.QIcon.On)
        icon.addPixmap(QtGui.QPixmap(":/devices/icons/ion_chamber.png"), QtGui.QIcon.Active, QtGui.QIcon.Off)
        self.device_button.setIcon(icon)
        self.device_button.setIconSize(QtCore.QSize(82, 150))

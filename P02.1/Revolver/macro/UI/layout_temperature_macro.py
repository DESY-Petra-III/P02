...
"QPushButton:disabled{ background:silver;color:grey }")
        ...
        self.gridLayout.addWidget(self.macro_main_controls, 4, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.macro_wait_controls, 6, 0, 1, 1)
...
"QPushButton:disabled{ background:silver;color:grey }")
        ...
        self.gridLayout.addWidget(self.macro_steps_controls, 7, 0, 1, 1)
        ...
        self.status_plot = QtGui.QGridLayout()
        self.status_plot.setObjectName("status_plot")
        self.gridLayout.addLayout(self.status_plot, 5, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.table.horizontalHeaderItem(3).setText(QtGui.QApplication.translate("Form", "Temperature", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.table.horizontalHeaderItem(6).setText(QtGui.QApplication.translate("Form", "Holding time", None, QtGui.QApplication.UnicodeUTF8))
        self.table.horizontalHeaderItem(7).setText(QtGui.QApplication.translate("Form", "Repat holding", None, QtGui.QApplication.UnicodeUTF8))
        self.table.horizontalHeaderItem(8).setText(QtGui.QApplication.translate("Form", "Wait", None, QtGui.QApplication.UnicodeUTF8))
        self.table.horizontalHeaderItem(9).setText(QtGui.QApplication.translate("Form", "Comment", None, QtGui.QApplication.UnicodeUTF8))
        self.table.horizontalHeaderItem(10).setText(QtGui.QApplication.translate("Form", "Dark", None, QtGui.QApplication.UnicodeUTF8))
        self.table.horizontalHeaderItem(11).setText(QtGui.QApplication.translate("Form", "Action", None, QtGui.QApplication.UnicodeUTF8))

...
"QPushButton:disabled{ background:silver;color:grey }")
        ...
        self.gridLayout.addWidget(self.macro_main_controls, 3, 0, 1, 1)
...
"}")
        ...
        self.gridLayout.addWidget(self.macro_wait_controls, 4, 0, 1, 1)
...
"}")
        ...
        self.loop_macro_progressbar = QtGui.QProgressBar(self.macro_steps_controls)
        self.loop_macro_progressbar.setEnabled(True)
        self.loop_macro_progressbar.setAutoFillBackground(False)
        self.loop_macro_progressbar.setProperty("value", 0)
        self.loop_macro_progressbar.setTextVisible(True)
        self.loop_macro_progressbar.setInvertedAppearance(False)
        self.loop_macro_progressbar.setTextDirection(QtGui.QProgressBar.TopToBottom)
...
"QPushButton:disabled{ background:silver;color:grey }")
        ...
        self.gridLayout.addWidget(self.macro_steps_controls, 5, 0, 1, 1)

...
# Form implementation generated from reading ui file '/tmp/tmpHI5Zix.ui'
#
# Created: Tue Jan 28 18:08:29 2014
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_8.addLayout(self.graph_layout, 0, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.controls, 2, 0, 1, 1)
        self.device_controllers = QtGui.QGridLayout()
        self.device_controllers.setSizeConstraint(QtGui.QLayout.SetFixedSize)
        self.device_controllers.setObjectName("device_controllers")
        spacerItem1 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.device_controllers.addItem(spacerItem1, 0, 0, 1, 1)
        self.gridLayout_8.addLayout(self.device_controllers, 1, 0, 1, 1)
